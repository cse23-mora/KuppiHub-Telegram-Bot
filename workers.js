...
const BOT_TOKEN = ""; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_CHANNEL = ; // Insert your telegram channel id which the bot is admin in.
const SIA_NUMBER = 1234; // Insert a random integer number and keep it safe.
const BOT_OWNER = ""; // Not numeric ID, use username for clickable button.
